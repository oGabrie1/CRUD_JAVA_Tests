...
public class ArquivoEspaco {
        ...
        private static boolean validarEntradas(String pisoStr, String areaStr) {

            if (pisoStr == null || pisoStr.trim().isEmpty() || areaStr == null || areaStr.trim().isEmpty()) {
                ultimaMensagem = "Verifique se a área e o piso são números válidos.";
            ...
            try {
                ...
                area = Double.parseDouble(areaStr.trim().replace(",", "."));
                piso = Integer.parseInt(pisoStr.trim());
            ...
            if (area <= 0 || (piso != 1 && piso != 2)) {
                ultimaMensagem = "Preencha todos os campos corretamente! (Área > 0 e Piso = 1 ou 2)";
                System.out.println(ultimaMensagem);
                return false;
            }
        ...
        public static boolean adicionarEspaco(String pisoStr, String areaStr) {
            if (!validarEntradas(pisoStr, areaStr)) {
                return false;
            }
            ...
            ultimaMensagem = "Espaço cadastrado com sucesso!"; // CT01
            System.out.println(ultimaMensagem);
            return true;
        }
        ...
        public static boolean editarEspaco(int id, String novoPisoStr, String novaAreaStr){
            ...
            if (!validarEntradas(novoPisoStr, novaAreaStr)) {
                return false;
            }
